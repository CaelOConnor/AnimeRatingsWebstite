...
async function makeUser(suffix = '') {
  return createUser({
    username: `rev_byuserid_user${suffix}`,
    email: `rev_byuserid_user${suffix}@example.com`,
...
afterEach(async () => {
  ...
  await query(`DELETE FROM users WHERE email LIKE 'rev_byuserid_user%@example.com'`);
});
